...
The choppah downloads the necessary audio, slices your regions, concatenates them with your chosen gap duration (adjustable, default 1s), and shows you a preview. Listen, then download.

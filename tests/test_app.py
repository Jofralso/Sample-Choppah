...
class TestUrlAllowlist:
    ...
    def test_youtube_music(self):
        assert is_allowed_url("https://music.youtube.com/watch?v=dQw4w9WgXcQ")

    def test_youtube_shorts(self):
        assert is_allowed_url("https://www.youtube.com/shorts/dQw4w9WgXcQ")

    def test_youtube_embed(self):
        assert is_allowed_url("https://www.youtube.com/embed/dQw4w9WgXcQ")

    def test_youtube_live(self):
        assert is_allowed_url("https://www.youtube.com/live/dQw4w9WgXcQ")

    def test_youtube_nocookie(self):
        assert is_allowed_url("https://www.youtube-nocookie.com/embed/dQw4w9WgXcQ")

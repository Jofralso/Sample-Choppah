...
import { $url, $btnGo, $file, $searchDrop, $btnExport, $gapDuration } from './dom.js';
import { renderBarRegions, renderChips, renderQueue } from './render.js';
import { handleGo, handleFile } from './sources.js';
import { handleExport, initExportPreview } from './export.js';
...
function init() {
  ...
  $gapDuration.addEventListener('input', renderQueue);
